...
class MainMenu(View):
    ...
    @discord.ui.select(
        ...
        options=[
            discord.SelectOption(label="Create VM", value="create"),
            discord.SelectOption(label="Delete VM", value="delete"),
            discord.SelectOption(label="Show VM Info", value="info"),
            discord.SelectOption(label="Configure your info", value="userdata")
        ]
    )
